...
class calculateTitanRangeJob implements ShouldQueue
{
    ...
    public function calculate_titan_nodes_ly($system_id, $ignore_regions)
    {
        ...
        // Cynos and Titans can only be present in lowsec, we will deal with blops after.
        ...
        foreach ($nodes as $node) {
            ...
            if ($result) {
                if ($result['lightyears'] <= 6) {
                    // Found System and Target within 5 Light Years, Add it to the Static Data.
                    $response[] = $result;
                }
            }
        }
